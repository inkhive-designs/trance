...
if ( ! function_exists( 'trance_setup' ) ) :
    ...
    function trance_setup() {
        ...
        add_image_size('trance-home-thumb', 240, 200, true);
        add_image_size('trance-aboutus-thumb', 500, 500, true);
    }
endif; // trance_setup
...
function trance_effects() {
    ...
    $custom_js	=	array(
        ...
        'bar2'      => get_theme_mod('trance_aboutus_skills2_per'),
        'progress1'      => get_theme_mod('trance_aboutus_skills3_per'),
    );
